...
knitr::include_graphics(file.path(system.file(package = "Bioc2019Anno", "vignettes"), "mapping.png"))
...
knitr::include_graphics(file.path(system.file(package = "Bioc2019Anno", "vignettes"), "boxes.png"))
...
knitr::include_graphics(file.path(system.file(package = "Bioc2019Anno", "vignettes"),"eset.png"))
...
load(file.path(system.file(package = "Bioc2019Anno", "extdata"), "eset.Rdata"))
eset
...
knitr::include_graphics(file.path(system.file(package = "Bioc2019Anno", "vignettes"), "subset.png"))

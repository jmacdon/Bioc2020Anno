...
knitr::include_graphics(file.path(system.file(package = "Bioc2020Anno", "vignettes"), "mapping.png"))
...
knitr::include_graphics(file.path(system.file(package = "Bioc2020Anno", "vignettes"), "boxes.png"))
...
knitr::include_graphics(file.path(system.file(package = "Bioc2020Anno", "vignettes"),"eset.png"))
...
knitr::include_graphics(file.path(system.file(package = "Bioc2020Anno", "vignettes"), "subset.png"))
...
## fix for now
zz <- seqinfo(whatIwant)
genome(zz) <- "GRCh38"
seqinfo(whatIwant) <- zz
